...
const alternatives = [
  {
    ...
    price: "1,800",
    pages: "Up to 8 pages",
    desc: "Everything in Foundation, plus a hands-on SEO audit built from Google's own ranking guidelines, dedicated service pages, analytics, and lead tracking. Turn visitors into calls.",

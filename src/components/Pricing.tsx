...
const alternatives = [
  {
    ...
    desc: "Everything in Foundation, plus a hands-on SEO audit built from Google's own ranking guidelines, dedicated service pages, a simple CMS so you can post updates yourself, analytics, and lead tracking. Turn visitors into calls.",

...
const alternatives = [
  ...
  },
  {
    ...
    desc: "First draft in week one. Everything in Growth, plus a full online store. Sell products, take payments, and manage customers from your own website. 60 days of guided support to make sure everything runs smooth.",

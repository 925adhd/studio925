...
export default function Hero() {
  return (
    <section className="relative pt-20 md:pt-32 pb-14 md:pb-20 px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <h1 className="flex items-center justify-center gap-1.5 flex-wrap text-[9px] sm:text-xs font-medium tracking-widest uppercase text-brand-primary/60 mb-2 sm:mb-5">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-7xl mb-2 md:mb-6 leading-[1.05] sm:leading-[1.1]">
            You deserve a website that <span className="italic text-brand-accent">works as hard as you do.</span>
          </h2>

          <p className="text-[17px] md:text-xl text-brand-primary/70 mb-7 md:mb-8 max-w-2xl leading-relaxed mx-auto">
          ...
          <div className="mt-7 sm:mt-12 flex flex-row flex-wrap gap-2 sm:gap-x-6 gap-y-2 sm:gap-y-3 items-center justify-center">

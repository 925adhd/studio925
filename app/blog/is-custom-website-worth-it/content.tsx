        ...
        <article className="max-w-3xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="mb-10">
            <img
              ...
              alt="Is a custom website worth it — small business owner reviewing website ROI math on a laptop"
              width={1024}
              height={1024}
          ...
          <div className="prose-studio">
            ...
            {/* The math */}
            <h2 className="text-2xl md:text-3xl mt-12 mb-6">The Real Question</h2>
            <p className="text-brand-primary/70 leading-relaxed mb-6">
              A custom small business website usually runs somewhere between $900 and $5,000 depending on scope. That's real money, and for a small business it's not pocket change. So the question worth asking is simple: <strong>how many customers does your website need to bring in to pay for itself?</strong>
            </p>
            <p className="text-brand-primary/70 leading-relaxed mb-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-8">
              <div className="p-6 rounded-2xl border border-brand-primary/10 bg-brand-primary/[0.02]">
                ...
                <p className="text-xs text-brand-primary/50">pays for the website <span className="text-emerald-600 font-semibold">2x over</span></p>
              </div>
              ...
              <div className="p-6 rounded-2xl border border-brand-primary/10 bg-brand-primary/[0.02]">
                ...
                <p className="text-2xl font-bold text-brand-primary mb-1">2 bookings</p>
                <p className="text-xs text-brand-primary/50">covers the website cost <span className="text-emerald-600 font-semibold">+ first year hosting</span></p>
              </div>
            ...
            <p className="text-brand-primary/70 leading-relaxed mb-8">
              For most service businesses, <strong>your website pays for itself within a handful of new customers.</strong> Everything after that is return on the original investment.
            </p>
            ...
            <div className="p-6 rounded-2xl border border-brand-primary/10 bg-white mb-8">
              <div className="space-y-3 text-sm">
                <div className="flex justify-between text-brand-primary/70"><span>Custom website build</span><span className="font-semibold">~$1,500</span></div>
                <div className="flex justify-between text-brand-primary/70"><span>12 months hosting & support</span><span className="font-semibold">~$500</span></div>
                <div className="flex justify-between font-bold text-brand-primary border-t border-brand-primary/10 pt-3 mt-3"><span>Total first year</span><span>~$2,000</span></div>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-brand-primary/5">
                ...
                <p className="text-[11px] text-brand-primary/40 mt-3">Even the most conservative scenario above clears the cost of the website several times over. Your actual numbers depend on your industry, average ticket, and how much traffic the site brings in.</p>
              </div>
            </div>

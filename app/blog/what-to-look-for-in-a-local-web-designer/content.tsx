          ...
          <div className="prose-studio">
            ...
            <div className="p-6 rounded-2xl bg-red-50/50 border border-red-200/40 mb-8">
              <ul className="space-y-3 text-sm text-brand-primary/70">
                ...
                <li className="flex items-start gap-3"><AlertTriangle size={16} className="text-red-500 mt-0.5 shrink-0" /><span><strong>"Website as a subscription" with no ownership.</strong> If the only way to have the site is to keep paying a monthly fee forever, and you don&apos;t own anything if you stop, that&apos;s a rental dressed up as a service. Hosting and maintenance subscriptions on top of a site you actually own are normal and fine.</span></li>

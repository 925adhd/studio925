...
const faqItems = [
  {
    ...
    answer: 'In most cases, yes. Under Section 179, small businesses can deduct the full cost of a business website in the year it was purchased rather than spreading it over several years. However, tax rules can change — always check with your accountant or tax professional to confirm what applies to your situation.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. The website needs to be used for business purposes — generating leads, serving customers, selling products, etc. A personal blog or hobby site wouldn\'t qualify. If your site is for your business, you\'re likely in the clear. Your tax professional can confirm.',
  },
];

      ...
      <main className="pt-32 pb-20 px-6">
        <section className="max-w-4xl mx-auto mb-24">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              <a href="/#pricing" className="bg-white border border-brand-primary/10 px-8 py-4 rounded-2xl text-lg font-semibold hover:bg-brand-primary/5 transition-colors text-center">
                View Pricing
              </a>
            </div>
          </motion.div>
        ...
        <section className="max-w-4xl mx-auto mb-24">
          ...
          <ul className="grid sm:grid-cols-2 gap-4 text-brand-primary/80">
            {['Contractors & tradespeople', 'Local service providers', 'Retail shops and boutiques', 'Restaurants and food businesses', 'Healthcare and wellness providers', 'Real estate professionals', 'Nonprofits and community organizations', 'Any small business ready to grow'].map((item) => (
        ...
        <section className="max-w-4xl mx-auto mb-24">
          <h2 className="text-3xl md:text-4xl mb-6">Why local businesses need professional web design</h2>
          <div className="space-y-6 text-brand-primary/70 text-lg leading-relaxed">
            <p>When someone in Leitchfield searches for a plumber, a contractor, or a place to eat, they're going to Google first. If your business doesn't have a website, or has one that looks outdated, they're going to call someone else.</p>
            <p>A well-built website signals trust. It tells potential customers that you're serious about your business, that you're easy to contact, and that you're the right choice. That matters in a small community where reputation is everything.</p>
            <p>In Grayson County, word travels fast. Your website should reinforce your reputation, not weaken it.</p>
            <p>Beyond appearance, a well-built website performs. Fast load times, clear navigation, and strong calls to action turn visitors into inquiries. That's the difference between a site that just exists and one that actively grows your business.</p>
          </div>
        </section>
        ...
        <section className="max-w-4xl mx-auto mb-24">
          ...
          <a href="/#pricing" className="inline-flex items-center gap-2 bg-brand-primary text-white px-6 py-3 rounded-2xl font-semibold hover:scale-[1.02] transition-transform">
        ...
        <section className="max-w-4xl mx-auto mb-24">
          ...
          <ul className="space-y-3 text-brand-primary/70">
            <li>
              <Link href="/website-design-leitchfield-ky" className="text-brand-accent hover:text-brand-accent/80 font-medium transition-colors">
        ...
        <section className="max-w-4xl mx-auto text-center py-16 px-8 bg-brand-primary text-white rounded-[2.5rem]">
          ...
          <a href="/#contact" className="inline-flex items-center gap-2 bg-brand-accent text-white px-8 py-4 rounded-2xl text-lg font-semibold hover:bg-brand-accent/90 transition-colors">

...
export default function LeitchfieldContent() {
  return (
    <div className="min-h-screen selection:bg-brand-accent selection:text-white">
      ...
      <section className="py-16 md:py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="space-y-4 md:space-y-6 text-brand-primary/70 text-sm md:text-lg leading-relaxed">
            ...
            <p>
              You might've seen sites that create hundreds of "city pages" just to rank. This isn't that. I'm <em className="italic text-brand-accent not-italic">actually</em> local, and this page exists because I work with businesses here. I built CS Media's website right here in Leitchfield, and <a href="https://townly.us" target="_blank" rel="noopener noreferrer" className="text-brand-accent underline underline-offset-2 hover:text-brand-accent/80 transition-colors">Townly</a> was built specifically for the Grayson County community.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Free audit band */}
      <FreeAuditBand
        headline="See how your business ranks across Leitchfield"
        subhead="The free local audit maps your real search rankings across Leitchfield and Grayson County for the queries your customers actually run. No login, no sales call."
      />
      ...
      <section className="py-12 md:py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-brand-primary/70 text-sm md:text-lg leading-relaxed mb-4 md:mb-6">
            Studio 925 builds websites for businesses across Grayson County, the rest of Kentucky, and a range of local industries.
          </p>

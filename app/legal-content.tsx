  ...
  return (
    <>
      ...
      <Section title="8. Hosting, Website Files, and Non-Payment">
        <p>Upon full payment for a website project, the client owns the final website design and custom code developed specifically for their project. {company} retains the right to display completed work in our portfolio and retains ownership of any proprietary tools, frameworks, or pre-existing materials used during development.</p>
      ...
      <Section title="13. Accessibility">
      ...
      <Section title="20. Waiver and Severability">
